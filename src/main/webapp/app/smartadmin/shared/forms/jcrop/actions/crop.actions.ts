...
export class CropActions {
  ...
  static CROP_SELECT = 'CROP_SELECT';
  static CROP_CHANGE = 'CROP_CHANGE';
  static CROP_FIELD_CHANGE = 'CROP_FIELD_CHANGE';
  static CROP_RANDOM_SELECTION = 'CROP_RANDOM_SELECTION';
